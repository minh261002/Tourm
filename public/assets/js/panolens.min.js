!(function (t, e) {
    ...
    function u(t) {
        ...
        try {
            ...
            (e = i.getContext("experimental-webgl")) ||
                (e = i.getContext("webgl"));
        } catch (t) {}
        ...
        (n = void 0 === n ? 1e4 : n),
            ...
            "image" === (void 0 === t ? "image" : t) &&
                r.call(
                    this,
                    i,
                    this.createGeometry(n, s),
                    this.createMaterial(n)
                ),
            (this.size = n),
            (this.ratio = s),
            (this.EPS = 1e-6),
    ...
    function g(t, i) {
            ...
            if (!1 !== g.enabled) {
                ...
                if (H === B.ROTATE) {
                    ...
                    E.set(t.clientX, t.clientY),
                        y.subVectors(E, f),
                        g.rotateLeft(
                            ((2 * Math.PI * y.x) / e.clientWidth) *
                                g.rotateSpeed
                        ),
                        g.rotateUp(
                            ((2 * Math.PI * y.y) / e.clientHeight) *
                                g.rotateSpeed
                        ),
                        f.copy(E),
                        u &&
                            ((U = t.clientX - u.clientX),
                            (_ = t.clientY - u.clientY)),
                        (u = t);
                } else if (H === B.DOLLY) {
                    if (!0 === g.noZoom) return;
        ...
        function a(t) {
            if (!1 !== g.enabled && !0 !== g.noZoom && H === B.NONE) {
                ...
                void 0 !== t.wheelDelta
                    ...
                    0 < e
                        ? ((g.object.fov =
                              g.object.fov < g.maxFov
                                  ? g.object.fov + 1
                                  : g.maxFov),
                          g.object.updateProjectionMatrix())
                        : 0 > e &&
                          ((g.object.fov =
                              g.object.fov > g.minFov
                                  ? g.object.fov - 1
                                  : g.minFov),
                          g.object.updateProjectionMatrix()),
                    g.update(),
        ...
        var z = new e.Quaternion().setFromUnitVectors(
                t.up,
                new e.Vector3(0, 1, 0)
            ),
            F = z.clone().inverse(),
        ...
        (this.setLastQuaternion = function (t) {
            ...
            (this.rotateLeft = function (t) {
                void 0 === t &&
                    (t = ((2 * Math.PI) / 60 / 60) * g.autoRotateSpeed),
                    (x -= t);
            }),
            ...
            (this.pan = function (t, i) {
                ...
                if (g.object instanceof e.PerspectiveCamera) {
                    ...
                    g.object instanceof e.OrthographicCamera
                        ? (g.panLeft(
                              (t * (g.object.right - g.object.left)) /
                                  n.clientWidth
                          ),
                          g.panUp(
                              (i * (g.object.top - g.object.bottom)) /
                                  n.clientHeight
                          ))
                        : console.warn(
            ...
            (this.update = function (t) {
                ...
                C.copy(e).sub(this.target),
                    ...
                    this.autoRotate &&
                        H === B.NONE &&
                        this.rotateLeft(
                            ((2 * Math.PI) / 60 / 60) * g.autoRotateSpeed
                        ),
                    this.momentum(),
                    (S += x),
                    (O += D),
            ...
            (this.update = function (t) {
                if (!1 !== n.enabled) {
                    var i = n.deviceOrientation.alpha
                            ? e.Math.degToRad(n.deviceOrientation.alpha) +
                              n.alphaOffsetAngle
                            : 0,
                        ...
                        r = n.deviceOrientation.gamma
                            ...
                            : 0,
                        h = n.screenOrientation
                            ? e.Math.degToRad(n.screenOrientation)
                            : 0,
    ...
    function y(t) {
        if (
            (((t = t || {}).controlBar =
                void 0 === t.controlBar || t.controlBar),
            ...
            (t.horizontalView =
                void 0 !== t.horizontalView && t.horizontalView),
            ...
            (t.autoRotateActivationDuration =
                t.autoRotateActivationDuration || 5e3),
            (this.options = t),
            t.container)
        ) {
            var i = t.container;
        ...
        (this.container = i),
            ...
            (this.renderer =
                t.renderer ||
                new e.WebGLRenderer({ alpha: !0, antialias: !1 })),
            ...
            (this.DeviceOrientationControls = new f(
                this.camera,
                this.container
            )),
    ...
    var b = "^0.105.2".replace(/[^0-9.]/g, ""),
        ...
        C = {
            load: function (t, i, n, s) {
                ...
                (d.crossOrigin =
                    void 0 !== this.crossOrigin ? this.crossOrigin : ""),
        ...
        (n.prototype = Object.assign(Object.create(e.Sprite.prototype), {
            ...
            setColor: function (t) {
                this.material.color.copy(
                    t instanceof e.Color ? t : new e.Color(t)
                );
            },
            ...
            update: function () {
                ...
                var t =
                    (performance.now() - this.startTimestamp) / this.dwellTime;
                        ...
                        update: function (t) {
                            ...
                            for (e in this._valuesEnd)
                                if (void 0 !== this._valuesStart[e]) {
                                    ...
                                    o instanceof Array
                                        ? (this._object[e] =
                                              this._interpolationFunction(o, n))
                                        : ("string" == typeof o &&
                                              (o =
                                                  "+" === o.charAt(0) ||
                                                  "-" === o.charAt(0)
                            ...
                            if (
                                ...
                                for (e in (isFinite(this._repeat) &&
                                    this._repeat--,
                                this._valuesStartRepeat))
    ...
    (s.prototype = Object.assign(Object.create(e.Sprite.prototype), {
        ...
        onDualEyeEffect: function (t) {
            if (this.getContainer()) {
                ...
                t &&
                    (t.left ||
                        t.right ||
                        ((t.left = t.cloneNode(!0)),
                        (t.right = t.cloneNode(!0))),
                    this.mode === M.CARDBOARD || this.mode === M.STEREO
        ...
        enableRaycast: function (t) {
            this.raycast =
                void 0 === t || t ? this.originalRaycast : function () {};
        },
        show: function (t) {
            t = void 0 === t ? 0 : t;
        ...
        (o.prototype = Object.assign(
            Object.create(e.EventDispatcher.prototype),
            {
                    ...
                    return [
                        ...
                        },
                        {
                            ...
                            subMenu: [
                                ...
                                {
                                    title: "Cardboard",
                                    handler: e("enableEffect", M.CARDBOARD),
                                },
                                {
                                    title: "Stereoscopic",
                                    handler: e("enableEffect", M.STEREO),
                                },
                            ],
                        },
                    ];
                        ...
                        (e.update = function (t) {
                            (this.paused = void 0 !== t ? t : this.paused),
                                (this.style.backgroundImage =
                                    'url("' +
                                    (this.paused ? I.VideoPlay : I.VideoPause) +
                                    '")');
                        }),
                        e
                    );
                ...
                createVideoControlSeekbar: function () {
                    function t(t) {
                        t.stopPropagation(),
                            ...
                            r.container.addEventListener("mousemove", e, {
                                passive: !0,
                            }),
                            r.container.addEventListener("mouseup", i, {
                                passive: !0,
                            }),
                            r.container.addEventListener("touchmove", e, {
                                passive: !0,
                            }),
                            r.container.addEventListener("touchend", i, {
                                passive: !0,
                            });
                    }
                    function e(t) {
                ...
                createMenuItemHeader: function (t) {
                    return (
                        ((t = this.createMenuItem(t)).style.borderBottom =
                            "1px solid #333"),
                    ...
                    function i(t) {
                        t.preventDefault(),
                            ...
                            "header" !== this.type &&
                                ...
                                s.activeMainItem.setSelectionTitle(
                                    this.textContent
                                ),
                    ...
                    for (
                        o.items = e,
                            ...
                            o
                                ...
                                .addIcon(void 0, !0, !0)
                                .addEventListener(
                                    s.TOUCH_ENABLED ? "touchend" : "click",
                                    i,
                                    !1
                                ),
                            t = 0;
                    ...
                    return (
                        ...
                        (e.unslideAll = function () {
                            for (var t = 0; t < e.children.length; t++)
                                e.children[t].unslide &&
                                    e.children[t].unslide();
                        }),
                        (e.addHeader = function (e) {
                            return (
                                ((e = t.createMenuItemHeader(e)).type =
                                    "header"),
                                this.appendChild(e),
                                e
                            );
                ...
                (this.visible = !0),
                    e
                        ? ((n = new s(
                          ...
                          (this.visible = !1))
                        : console.warn(
                              "Please specify infospot position for linking"
                          );
            },
            reset: function () {
        ...
        onMouseDown: function (t) {
            switch ((t.touches && t.touches.length) || 1) {
                ...
                case 2:
                    (e = t.touches[0].pageX - t.touches[1].pageX),
                        (t = t.touches[0].pageY - t.touches[1].pageY),
                        (this.userMouse.pinchDistance = Math.sqrt(
                            e * e + t * t
                        ));
            }
    ...
    (y.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        ...
        checkSpriteInViewport: function (t) {
            return (
                ...
                this.cameraFrustum.setFromMatrix(
        ...
        tweenControlCenter: function (t, i, n) {
            ...
            if (this.control === this.OrbitControls) {
                ...
                (a.y = 0),
                    ...
                    (h =
                        (h =
                            (h = Math.atan2(t.z, t.x) - Math.atan2(a.z, a.x)) >
                            Math.PI
                                ? h - 2 * Math.PI
                                : h) < -Math.PI
                            ? h + 2 * Math.PI
                    ...
                    (a = Math.abs(
                        r.angleTo(a) +
                            (0 >= r.y * c.y ? c.angleTo(t) : -c.angleTo(t))
                    )),
                    (a *= c.y < r.y ? 1 : -1),
                    (r = { left: 0, up: 0 });
                var l = (s = 0);
        ...
        onMouseDown: function (t) {
            t.preventDefault(),
                (this.userMouse.x =
                    0 <= t.clientX ? t.clientX : t.touches[0].clientX),
                (this.userMouse.y =
                    0 <= t.clientY ? t.clientY : t.touches[0].clientY),
        ...
        onMouseUp: function (t) {
            ...
            var e =
                (this.userMouse.x >= t.clientX - this.options.clickTolerance &&
                    this.userMouse.x <=
                        t.clientX + this.options.clickTolerance &&
                    this.userMouse.y >=
                        t.clientY - this.options.clickTolerance &&
                    this.userMouse.y <=
                        t.clientY + this.options.clickTolerance) ||
                (t.changedTouches &&
                    this.userMouse.x >=
            ...
            if (
                (!t ||
                    !t.target ||
                    t.target.classList.contains("panolens-canvas")) &&
                (t.preventDefault(),
                (t =
                ...
                e.autoHideInfospot && i && i.toggleInfospotVisibility(),
                    t && n();
            }
        },
        onTap: function (t, e) {
            ...
            if (
                ...
                if (
                    ((("mousedown" !== t.type && this.touchSupported) ||
                        ...
                        this.outputPosition(),
                    (i = this.raycaster.intersectObjects(
        ...
        hideInfospot: function () {
            this.infospot &&
                (this.infospot.onHoverEnd(), (this.infospot = void 0));
        },
                    ...
                    function (t) {
                        if (
                            ...
                            (this.hoverObject === t ||
                                ...
                                (t.element.left &&
                                    "none" !== t.element.left.style.display) ||
                                (t.element.right &&
                                    "none" !== t.element.right.style.display))
                        )
                ...
                if (0 !== i.loaded) {
                    ...
                    t.addUpdateCallback(function () {
                        (t.radius = 0.225 * t.viewIndicatorSize),
                            (t.currentPanoAngle =
                                t.camera.rotation.y - e.Math.degToRad(90)),
                            (t.fovAngle = e.Math.degToRad(t.camera.fov)),
                            (t.leftAngle =
                                -t.currentPanoAngle - t.fovAngle / 2),
                            (t.rightAngle =
                                -t.currentPanoAngle + t.fovAngle / 2),
