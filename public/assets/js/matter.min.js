                    ...
                    !(function () {
                        (o._inertiaScale = 4),
                            ...
                            (o.nextCategory = function () {
                                return (
                                    (o._nextCategory = o._nextCategory << 1),
                                    o._nextCategory
                                );
                            });
                        var e = function (e, t) {
                            (t = t || {}),
                                o.set(e, {
                                    ...
                                    positionPrev:
                                        e.positionPrev || r.clone(e.position),
                        ...
                        (o.set = function (e, t, n) {
                                ...
                                for (var n = 0; n < e.parts.length; n++) {
                                    ...
                                    (o.isStatic = t),
                                        t
                                            ...
                                            : o._original &&
                                              ((o.restitution =
                                                  o._original.restitution),
                                              (o.friction =
                                                  o._original.friction),
                            ...
                            (o.update = function (e, t, n, o) {
                                ...
                                (e.velocity.x =
                                    d * a * o + (e.force.x / e.mass) * s),
                                    (e.velocity.y =
                                        u * a * o + (e.force.y / e.mass) * s),
                ...
                function (e, t, n) {
                    ...
                    (o.create = function (e) {
                        ...
                        (o.remove = function (e, t, n) {
                            ...
                            return (
                                i.trigger(e, "afterRemove", { object: t }), e
                            );
                        }),
                            ...
                            for (
                                ...
                                if (m.isActive && !m.isSensor) {
                                    var f = m.collision,
                                        ...
                                        b = 1 / h.length;
                                    (v.velocity.x =
                                        v.position.x - v.positionPrev.x),
                                        (v.velocity.y =
                                            v.position.y - v.positionPrev.y),
                                        (y.velocity.x =
                                    ...
                                    for (var w = 0; w < h.length; w++) {
                                        ...
                                        if (
                                            ...
                                            (F *= q),
                                            I < 0 &&
                                                I * I > o._restingThresh * n)
                                        )
                                            S.normalImpulse = 0;
                                        else {
                                            var N = S.normalImpulse;
                                            (S.normalImpulse = Math.min(
                                                S.normalImpulse + _,
                                                0
                                            )),
                                                (_ = S.normalImpulse - N);
                    ...
                    !(function () {
                        o.collides = function (t, o, s) {
                            ...
                            if (s && u) {
                                ...
                                if (
                                    (a = e(t.vertices, o.vertices, t.axes))
                                        .overlap <= 0
                                )
                                    return (d.collided = !1), d;
                                if (
                                    (l = e(o.vertices, t.vertices, o.axes))
                                        .overlap <= 0
                                )
                                    return (d.collided = !1), d;
                                a.overlap < l.overlap
                        ...
                        (o.create = function (t) {
                            ...
                            n.bodyA && !n.pointA && (n.pointA = { x: 0, y: 0 }),
                                n.bodyB &&
                                    ...
                                    (n.pointB = { x: 0, y: 0 });
                            var o = n.bodyA
                                    ? r.add(n.bodyA.position, n.pointA)
                                    : n.pointA,
                                i = n.bodyB
                                    ? r.add(n.bodyB.position, n.pointB)
                                    : n.pointB,
                            ...
                            (o.solve = function (t, n) {
                                ...
                                if (
                                    ...
                                    var p = (u - t.length) / u,
                                        ...
                                        f = r.mult(
                                            d,
                                            0.5 * p * t.stiffness * n * n
                                        );
                                    if (
                                        !(
                                            Math.abs(1 - u / t.length) <
                                            0.001 * n
                                        )
                                    ) {
                                        var v, y, g, x, h, b, w, S;
                    ...
                    !(function () {
                        ...
                        var e = function (e) {
                            var t = e.mouse,
                                n = t.sourceEvents;
                            n.mousemove &&
                                a.trigger(e, "mousemove", { mouse: t }),
                                n.mousedown &&
                                    a.trigger(e, "mousedown", { mouse: t }),
                                n.mouseup &&
                                    a.trigger(e, "mouseup", { mouse: t }),
                    ...
                    !(function () {
                        (o.create = function (e, t) {
                            ...
                            return (
                                o.render &&
                                    o.render.controller &&
                                    (o.render = o.render.controller.create(
                                        o.render
                                    )),
                                o.render && (o.render.engine = o),
                                (o.world = t.world || i.create(o.world)),
                                (o.pairs = l.create()),
                                (o.broadphase = o.broadphase.controller.create(
                                    o.broadphase
                                )),
                            ...
                            return (
                                ...
                                (n.mousemove = function (t) {
                                    ...
                                    t.changedTouches &&
                                        ...
                                        (n.absolute.y = o.y),
                                        (n.position.x =
                                            n.absolute.x * n.scale.x +
                                            n.offset.x),
                                        (n.position.y =
                                            n.absolute.y * n.scale.y +
                                            n.offset.y),
                    ...
                    (o._registry = {}),
                        ...
                        (o.isFor = function (e, t) {
                            ...
                            return (
                                !e.for ||
                                (t.name === n.name &&
                                    o.versionSatisfies(t.version, n.range))
                            );
                        }),
                        (o.use = function (e, t) {
                            if (
                            ...
                            for (var n = t * t * t, i = 0; i < e.length; i++) {
                                ...
                                if (r.isActive) {
                                    ...
                                    if (
                                        ...
                                        var c =
                                                a.isSleeping && !a.isStatic
                                                    ? a
                                                    : l,
                                            d = c === a ? l : a;
                                        !c.isStatic &&
                                            d.motion >
                                                o._motionWakeThreshold * n &&
                                            o.set(c, !1);
                                    }
                                }
                            }
                ...
                function (e, t, n) {
                    ...
                    (o.stack = function (e, t, n, o, r, s, l) {
                        ...
                        (o.newtonsCradle = function (e, t, n, o, s) {
                            for (
                                var a = i.create({ label: "Newtons Cradle" }),
                                    c = 0;
                                c < n;
                                c++
                            ) {
                        ...
                        (function () {
                            o.pathToVertices = function (t, n) {
                                ...
                                for (c = l.concat(); v < r; ) {
                                    ...
                                    switch (
                                        a.pathSegTypeAsLetter.toUpperCase()
                                    ) {
                                        case "C":
                                        case "T":
                                        case "S":
                        ...
                        "undefined" != typeof window &&
                            ...
                            (o.create = function (e) {
                                ...
                                return (
                                    r.canvas &&
                                        ((r.canvas.width =
                                            r.options.width || r.canvas.width),
                                        (r.canvas.height =
                                            r.options.height ||
                                            r.canvas.height)),
                                    (r.mouse = e.mouse),
                                    ...
                                    (r.canvas =
                                        r.canvas ||
                                        n(r.options.width, r.options.height)),
                            ...
                            (o.world = function (e) {
                                ...
                                !f.wireframes ||
                                (n.enableSleeping && f.showSleeping)
                                    ? o.bodies(e, x, p)
                                    : (f.showConvexHulls &&
                                          o.bodyConvexHulls(e, x, p),
                                      o.bodyWireframes(e, x, p)),
                                    f.showBounds && o.bodyBounds(e, x, p),
                                    (f.showAxes || f.showAngleIndicator) &&
                                        o.bodyAxes(e, x, p),
                                    f.showPositions && o.bodyPositions(e, x, p),
                                    f.showVelocity && o.bodyVelocity(e, x, p),
                                    f.showIds && o.bodyIds(e, x, p),
                                    f.showSeparations &&
                                        o.separations(e, n.pairs.list, p),
                                    f.showCollisions &&
                                        o.collisions(e, n.pairs.list, p),
                                    f.showVertexNumbers &&
                                        o.vertexNumbers(e, x, p),
                                    f.showMousePosition &&
                            ...
                            (o.world = function (e) {
                                ...
                                if (c.hasBounds) {
                                    for (t = 0; t < d.length; t++) {
                                        var g = d[t];
                                        g.render.sprite.visible = i.overlaps(
                                            g.bounds,
                                            e.bounds
                                        );
                                    }
