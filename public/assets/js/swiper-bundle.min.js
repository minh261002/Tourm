            ...
            loop: {
                loopCreate: function (e) {
                    ...
                    !s.loop ||
                        ...
                        (h(a, `.${s.slideClass}, swiper-slide`).forEach(
                            (e, t) => {
                ...
                i >= 0 && u.splice(i, 1),
                    l &&
                        ...
                        m.imageEl &&
                            ...
                            (m.imageEl.style.transitionDuration =
                                t.params.speed + "ms"),
                            (m.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`),
                            (c = a.scale),
                            (p = !1),
