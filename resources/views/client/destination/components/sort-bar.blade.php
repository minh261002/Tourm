    ...
    <div class="col-md-4">
        <div class="search-form-area">
            <form class="search-form" method="GET">
                <input type="text" placeholder="Tìm kiếm điểm đến" name="query" value="{{ request('query') }}">
    ...
    <div class="col-md-auto">
        <div class="sorting-filter-wrap">
            <div class="nav" role="tablist">
                <a class="active" href="#" id="tab-destination-grid" data-bs-toggle="tab"
                    data-bs-target="#tab-grid" role="tab" aria-controls="tab-grid" aria-selected="true"><i
                        class="fa-light fa-grid-2"></i></a>
