            ...
            <div class="swiper th-slider has-shadow slider-drag-wrap"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="tour-box th-ani gsap-cursor">
                            <div class="tour-box_img global-img">
                                <img src="{{ asset('assets/img/tour/tour_box_2.jpg') }}" alt="image">
                            </div>
                            <div class="tour-content">
                    ...
                    <div class="swiper-slide">
                        <div class="tour-box th-ani gsap-cursor">
                            <div class="tour-box_img global-img">
                                <img src="{{ asset('assets/img/tour/tour_box_3.jpg') }}" alt="image">
                            </div>
                            <div class="tour-content">
                    ...
                    <div class="swiper-slide">
                        <div class="tour-box th-ani gsap-cursor">
                            <div class="tour-box_img global-img">
                                <img src="{{ asset('assets/img/tour/tour_box_4.jpg') }}" alt="image">
                            </div>
                            <div class="tour-content">
